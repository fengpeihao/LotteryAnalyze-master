...
class ETCFFrequencyBean : Serializable {
    /**
     * 号码 [01-11]
     */
    var number: String = ""
...
//            return ((preOmit - currentOmit) % cycle) / cycle
            return (preOmit - currentOmit) / cycle
        }
    ...
    override fun toString(): String {
        return "ETCFFrequencyBean(number='$number', " +
                "总期数=$totalPeriod, " +
                "出现次数=$displayCount, " +
                "理论次数=$theoryCount, " +
